...
const en = {
  ...
  "draw.skip_too_late": "You can only skip before you start drawing.",
  "draw.no_skips_left": "No skips left this turn.",
  "draw.undo": "Undo",
  "draw.clear": "Clear",
  "draw.skip": "Skip ({n})",
...
const nb = {
  ...
  "draw.skip_too_late": "Du kan bare hoppe over før du begynner å tegne.",
  "draw.no_skips_left": "Ingen overhopp igjen denne runden.",
  "draw.undo": "Angre",
  "draw.clear": "Tøm",
  "draw.skip": "Hopp over ({n})",
